...
class JConfig {
	...
	public $sitename = '{{ joomla_sitename| default("Joomla deployed website") }}';
	...
	public $error_reporting = '{{ joomla_error_reporting| default("") }}';
	public $helpurl = '{{ joomla_helpurl| default("https://help.joomla.org/proxy?") }}';
	...
	public $log_path = '{{ joomla_log_path| default(0) }}';
